...
public class ProxyCompiler {
  public static final ProxyCompiler me = new ProxyCompiler();

  private ProxyCompiler() {
  }

  protected static final Logger log = LoggerFactory.getLogger(ProxyCompiler.class);
  ...
  protected List<String> getOptions() {
    ...
    synchronized (this) {
      ...
      ret.add("-target");
      ret.add(System.getProperty("java.specification.version"));
