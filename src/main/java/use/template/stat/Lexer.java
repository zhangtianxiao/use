...
class Lexer {
  ...
  public Lexer(String content, String fileName, Set<String> keepLineBlankDirectives) {
  ...
  String subBuf(int start, int end) {
    ...
    String ret = new String(buf, start, end - start + 1);
    return ret;
  }
